...

{
  programs.fish = {
    ...
    shellAliases =
      ...
      ff = "fastfetch";
      xfix2 = "xrandr --output HDMI-1-1 --mode 1920x1080 --rate 144 --same-as eDP-2 && xrandr --output eDP-2 --mode 1920x1080";
      xfix1 = "xrandr --output HDMI-1-1 --mode 1920x1080 --rate 144 --same-as eDP-1 && xrandr --output eDP-1 --mode 1920x1080";
